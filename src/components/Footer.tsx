...
export const Footer: React.FC = () => {
  return (
    <footer className="relative text-[var(--color-on-surface-variant)] pt-12 pb-8 bg-gradient-to-b from-[var(--color-surface-alt)] via-[var(--color-background)] to-[var(--color-background)]">
      {/* Golden top border */}
      <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#C9A84C]/50 to-transparent" aria-hidden="true" />
      {/* Gothic arch divider */}
      <div className="absolute top-2 left-0 right-0 flex justify-center" aria-hidden="true">
        <img src="/svg/gothic-arch-divider.svg" alt="" className="w-64 h-12 opacity-30" />
      </div>

      {/* Lavender sprig decoration */}
      <div className="absolute top-8 left-1/2 -translate-x-1/2 opacity-20 pointer-events-none" aria-hidden="true">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <span className="font-cinzel font-bold tracking-wider text-sm text-[var(--color-on-surface)] block leading-none">
            ...
            {/* Motto plaque */}
            <div className="p-4 rounded-xl border border-[#C9A84C]/30 bg-[var(--color-surface)]/50 mb-4 relative overflow-hidden">
              <div className="absolute inset-0 opacity-5" aria-hidden="true">
                <img src="/svg/rune-circle.svg" alt="" className="w-full h-full object-contain" />
              </div>
              <p className="font-cormorant italic text-[var(--color-lavender)] text-center relative z-10">
            ...
            <ul className="type-body text-[var(--color-on-surface-variant)] space-y-2 mt-3">
              <li><a href="/" className="animated-underline text-[var(--color-primary)]">Início</a></li>
              <li><a href="/academia" className="animated-underline text-[var(--color-primary)]">Academia & Guias</a></li>
              <li><a href="/calendario" className="animated-underline text-[var(--color-primary)]">Calendário</a></li>
              <li><a href="/receitas" className="animated-underline text-[var(--color-primary)]">Receitas</a></li>
            </ul>
          </div>

          {/* Column 2: Campus Physical (FC House) */}
          <div>
