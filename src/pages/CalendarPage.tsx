                ...
                >
                  ...
                  <div className="space-y-0.5 mt-1">
                      {dayEvs.map(ev => {
                        ...
                        const curMonthIdx = REAL_MONTH_NAMES.indexOf(REAL_MONTH_NAMES[TODAY.getMonth()]);
                        const dispMonthIdx = REAL_MONTH_NAMES.indexOf(currentMonth.name);
                        const sameMonth = Number(currentMonth.cycle) === TODAY.getFullYear() && curMonthIdx === dispMonthIdx;
                        const dayPassed = sameMonth && day < TODAY.getDate();
                        const past = isEventPast(ev) || dayPassed;
                        return (
                          <button
                            key={ev.id}
